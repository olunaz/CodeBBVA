...
function fWorkflowRiesgos2() {
  ...
  var rVerCodSol = sheetEO.getRange("D1"); // Columnas del Drive
  ...
  rngdelete.clear();
  rngdelete.clearNote();
  rngdelete.setVerticalAlignment("middle"); //Borrar rango previamente utilizado
  ...
  var myrngFontSize = [[14, "", "", ""], [12, "", 12, ""]];
  var myrngColor = [["#1c4587", "", "", ""], ["#a5c2f4", "", "#a5c2f4", ""]];
  var myrngHeadings = [["Estado del WorkFlow", "", "", ""], ["Ingreso", "", "Evaluación", ""]];
  var myrngFontColor = [["white", "", "", ""], ["black", "", "black", ""]];
  rngFormat.setFontSizes(myrngFontSize);
  rngFormat.setBackgrounds(myrngColor);
  rngFormat.setValues(myrngHeadings);
  rngFormat.setFontColors(myrngFontColor); //Formatos de los títulos del WorkFlow
  ///////////////////////////////////////////
  ...
  for (var i = 1; i <= lRowWF - finicioWF + 1; i++) {
    ...
    if (codSolWF === codSolEO) {
      ...
      for (var j = cCheckList; j <= lColumnWF; j++) {
        //Asume que la primera fecha a registrar es el la de la columna del CheckList
        ...
        switch (j) {
          //La variable "j" equivale a las columnas de la base WF. Cada caso es una columna que corresponde a un heading de la base.
          case cCheckList:
            var valMoveCL = false;
          ...
          case cDevuelveCheckList:
            ...
            if (datoWF != "") {
              ...
              if (valMoveCL === false) {
                fEO = fEO + 1;
              } //Se usa para que no se muevan las cajas de las estaciones. Si no, se saltaría un fEO.
          ...
          case cCBC:
            ...
            if (datoWF != "") {
              ...
              if (valFS != "" && valDevRespuestas === "") {
                ...
                if (valDevFS === "" && valRespFS === "" && valFS === "") {} else if (valRespFS != "" && valFS === "") {} else if (valFS != "") {
                  valtoastrec = false;
          ...
          case cRcR1:
            ...
            if (datoWF === "") {
              ...
              if (sheetEO.getName() === "E1" && celdaEO.offset(-1, 0).getValue() != strRiReg2) {
                Browser.msgBox("Mensaje para Oficina", "Segmento Empresas ha devuelto la operación por falta de respuestas.", Browser.Buttons.OK);
              }
            } else {
              celdaEO.setValue(datoWF);
              celdaEO.setFontWeight("bold");
...
function RegistrarFechaRiesgos2() {
  ...
  var verCodSol = sheetEO.getRange("D1").getValue(); //Columnas de la base de registro del formulario.
  ...
  var cAnAsigForm = 22; //Columnas de la base de registro del formulario.
  ...
  var strRiReg = "SEGMENTO EMPRESAS: CONFIRMAR O DEVOLVER";
  var strRiReg2 = "SEGMENTO EMPRESAS: REGISTRE FECHA";
  var strRiReg3 = "SEGMENTO EMPRESAS: CONFIRMAR O CONSULTAR"; // Columnas del Drive
        ...
        for (var j = 1; j <= lColumnWF; j++) {
          ...
          if (headingWF === headingEO) {
            ...
            if (headingWF === "Revisión" && decRi === "yes") {
              ...
              if (motivo === "A") {
                motivo = "Errores en el Check List";
              } else if (motivo === "B") {
                motivo = "Calidad de Documentos";
              } else {
              ...
              if (respuestamail === "yes") {
                ...
                var options = {
                  cc: correoResp + ", wendy.amaya.tobon@bbva.com, siom@bbva.com"
                };
  ...
  //Solo para la estación 2
      ...
      for (var i = finicioEO; i <= lRowEO; i++) {
        ...
        if (val === strRiReg || val === strRiReg2 || val === strRiReg3) {
          ...
          else if (headingEO === "Devolución") {} else if (headingEO === "Reingreso con Respuestas") {}
          ...
          for (var j = 1; j <= lColumnWF; j++) {
            ...
            if (headingWF === headingEO) {
              ...
              if (headingWF === "Fecha Cierre" && decRi === "no"
              /* && HEOCRC != "Consulta de Riesgos a Cliente" */
              && valNDEV === "") {
                var recipient = Correo;
              ...
              return;
                  ...
                  if (decRespMetod === "N/A") {
                    tsFS = "Procesada Sin Respuestas";
                  }

                  if (respCompl === "") {
                    tsFS = "Procesada";
                  } else if (respCompl === "yes") {
                    tsFS = "Procesada con Respuestas Completas";
                  } else if (respCompl === "no") {
                    tsFS = "Procesada con Respuestas Parciales";
                  }
                  ...
                  while (valHerramienta === false) {
                    ...
                    if (herramienta === "A") {
                      herramienta = "EEFF Web";
                    } else if (herramienta === "B") {
                      herramienta = "NACAR";
                    } else if (herramienta === "C") {
                      herramienta = "Manual";
                    } else {
                  ...
                  if (sheetWF.getRange(fEncontrada, cArchivoResp).getValue() === "N/A") {
                    /*No hace nada*/
...
function fDesOp2() {
  ...
  if (notasAd === "A") {
    ...
    notasAd = "DESESTIMADO POR OFICINA";
  } else if (notasAd === "C") {
    notasAd = "RA";
  } else if (notasAd === "D") {
    notasAd = "LISTA PRIORIZADA";
  } else if (notasAd === "E") {
