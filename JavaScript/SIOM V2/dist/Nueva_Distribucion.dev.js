...
function lectura_esctritura_LG() {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    var herramienta_sancion = data[i][44]; //var fc = new Date(marca_temporal);
    ...
    analista_siom == "LOURDES DEL PILAR GUTIERREZ MANCHEGO", tipo_sancion == ""; //]
...
function lectura_esctritura_CC() {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    analista_siom == "CRISTOPHER CERRON BAQUERIZO", tipo_sancion == ""; //]
