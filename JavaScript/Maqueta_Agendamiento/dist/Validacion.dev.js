...
function validar_ingreso() {
  ...
  var fc_prime = Utilities.formatDate(fc, "GMT-5", "dd-MM-yyyy"); //Creacion de llaves validadoras
  ...
  if (oficina_prime == "TODAS LAS OFICINAS") {
    var oficina_total = ["OF. BANCA INSTITUCIONAL", "BANCA CORPORATIVA LOCAL", "BE CENTRAL", "BE LIMA 1", "BE CHICLAYO", "BE NORTE CHICO", "BE MIRAFLORES", "BE PIURA", "BE REPÚBLICA DE PANAMÁ", "BE TRUJILLO", "BE AREQUIPA", "BE CHACARILLA", "BE SUR CHICO", "BE CUSCO", "BE LA MOLINA", "BE LIMA ORIENTE", "BE LIMA OESTE 2", "BE SANTA CRUZ", "BE LIMA OESTE 1", "BE DOS DE MAYO", "BE HUANCAYO", "BE LIMA CENTRO", "BE SAN ISIDRO"];
